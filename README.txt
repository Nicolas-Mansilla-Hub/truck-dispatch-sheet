...
2. Add your `credenciales.json` file to the project folder (not included)
3. Run the script: `python smart_dispatcher.py`

---

**Author**: [Nico Mansilla](https://www.linkedin.com/in/...)